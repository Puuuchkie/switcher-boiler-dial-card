...
`;class ft extends at{constructor(){super(),this.timerValue="15"}static getConfigElement(){return document.createElement("switcher-boiler-card-editor")}static getStubConfig(){return{type:"custom:switcher-boiler-card",name:"Boiler",entity:"",icon:"",time_left:"",sensor_1:"",sensor_2:"",icon_sensor:"",color_thresholds:!1,cold_threshold:20,hot_threshold:50,temp_resolution:1}}setConfig(t){if(!t.entity)throw new Error("You need to define an entity");this.config=t,this.timerValue=this.config.timer_values?this.config.timer_values[0]:"15";const e=this.config.cold_threshold;if(this.config.hot_threshold<=e)throw new Error("Cold Threshold must be lower then Hot Threshold");let i=this.config.temp_resolution;if(null!=i&&null!=i&&""!=i&&(i=Number(i),isNaN(i)||![0,1,2].includes(i)))throw new Error("Temperature Resolution must be a number and only 0, 1, or 2")}render(){var t,e,i,s,o,n;const{name:r,icon:a,entity:l}=this.config,c=!0===this.config.color_thresholds,h=this.config.cold_threshold||20,d=this.config.hot_threshold||50,u=null!==(t=this.config.temp_resolution)&&void 0!==t?t:1,p=null===(i=null===(e=this.hass)||void 0===e?void 0:e.states)||void 0===i?void 0:i[l];if(!p)return;const f=(null===(s=null==p?void 0:p.attributes)||void 0===s?void 0:s.friendly_name)||"Unknown Entity",g=r||f,m=(null==p?void 0:p.state)||"Unavailable",_=a||(null===(o=null==p?void 0:p.attributes)||void 0===o?void 0:o.icon)||"mdi:waves",v="on"===m,b=parseFloat(null===(n=this.hass.states[this.config.icon_sensor])||void 0===n?void 0:n.state),$=this.config.icon_sensor&&this.hass.states[this.config.icon_sensor]&&!isNaN(b);let y="icon-container",w="icon-sensor";c&&$?b<=h?(y+=" cold",w+=" cold"):b>h&&b<=d?(y+=" warm",w+=" warm"):(y+=" hot",w+=" hot"):v?(y+=" on",w+=" on"):(y+=" off",w+=" off"),w+=0===u?" resolution-0":2===u?" resolution-2":" resolution-1";const x=v?"icon on":"icon off";let A="";v?(!this.config.time_left||this.config.sensor_1||this.config.sensor_2||(A=this.hass.states[this.config.time_left].state),this.config.time_left&&!this.config.sensor_1&&this.config.sensor_2&&(A=this.hass.states[this.config.time_left].state+" • "+this.hass.states[this.config.sensor_2].state+this.hass.states[this.config.sensor_2].attributes.unit_of_measurement),this.config.time_left&&this.config.sensor_1&&!this.config.sensor_2&&(A=this.hass.states[this.config.time_left].state+" • "+this.hass.states[this.config.sensor_1].state+this.hass.states[this.config.sensor_1].attributes.unit_of_measurement),this.config.time_left&&this.config.sensor_1&&this.config.sensor_2&&(A=this.hass.states[this.config.time_left].state+" • "+this.hass.states[this.config.sensor_1].state+this.hass.states[this.config.sensor_1].attributes.unit_of_measurement+" • "+this.hass.states[this.config.sensor_2].state+this.hass.states[this.config.sensor_2].attributes.unit_of_measurement),!this.config.time_left&&this.config.sensor_1&&this.config.sensor_2&&(A=this.hass.states[this.config.sensor_1].state+this.hass.states[this.config.sensor_1].attributes.unit_of_measurement+" • "+this.hass.states[this.config.sensor_2].state+this.hass.states[this.config.sensor_2].attributes.unit_of_measurement),this.config.time_left||this.config.sensor_1||!this.config.sensor_2||(A=this.hass.states[this.config.sensor_2].state+this.hass.states[this.config.sensor_2].attributes.unit_of_measurement),this.config.time_left||!this.config.sensor_1||this.config.sensor_2||(A=this.hass.states[this.config.sensor_1].state+this.hass.states[this.config.sensor_1].attributes.unit_of_measurement),this.config.time_left||this.config.sensor_1||this.config.sensor_2||(A=this.hass.localize("component.switch.entity_component._.state.on")||"on")):this.config.sensor_2?(A=this.hass.localize("component.switch.entity_component._.state.off")||"off",A+=" • "+this.hass.states[this.config.sensor_2].state,A+=this.hass.states[this.config.sensor_2].attributes.unit_of_measurement):A=this.hass.localize("component.switch.entity_component._.state.off")||"off";const S=v?"button power on":"button power off",E=this.isDarkTheme()?"button dark-theme":"button light-theme";return V`
      <ha-card class="card" id="card">
        <div class="container">
          ...
          >
            <div class="${y}" id="icon-container">
              ${$?this.renderIconSensor(w,b,u):this.renderIcon(x,_)}
            </div>
            <div class="label">
...
`;const mt=120,_t=120,vt=85,bt=2*Math.PI*vt;class $t extends at{constructor(){super(...arguments),this._totalAngle=0,this._dragging=!1,this._lastRawAngle=0,this._dragStarted=!1,this._prevEntityState=""}static getConfigElement(){return document.createElement("switcher-boiler-card-circular-editor")}static getStubConfig(){return{type:"custom:switcher-boiler-card-circular",name:"Boiler",entity:"",icon:"",time_left:"",power_sensor:"",timer_limit:90}}setConfig(t){if(!t.entity)throw new Error("You need to define an entity");this.config=t,this._totalAngle=0}updated(t){var e,i,s,o;if(super.updated(t),!t.has("hass")||!(null===(e=this.config)||void 0===e?void 0:e.entity))return;const n=null===(s=null===(i=this.hass)||void 0===i?void 0:i.states)||void 0===s?void 0:s[this.config.entity],r=null!==(o=null==n?void 0:n.state)&&void 0!==o?o:"";"on"===this._prevEntityState&&"on"!==r&&(this._totalAngle=0),this._prevEntityState=r}get _timerMinutes(){return Math.round(this._totalAngle/360*60)}get _partialAngle(){return this._totalAngle%360}get _fullRotations(){return Math.floor(this._totalAngle/360)}get _maxAngle(){var t;const e=null===(t=this.config)||void 0===t?void 0:t.timer_limit;return(null!=e&&""!==e?Number(e):150)/60*360}get _timerDisplay(){const t=this._timerMinutes;if(t<60)return String(t);return`${Math.floor(t/60)}:${(t%60).toString().padStart(2,"0")}`}get _timerUnit(){return this._timerMinutes>=60?"hr":"min"}_rawAngleFromPointer(t){var e;const i=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector(".timer-svg");if(!i)return 0;const s=i.getBoundingClientRect(),o=240/s.width;return function(t,e){let i=180*Math.atan2(e,t)/Math.PI+90;return i<0&&(i+=360),i>=360&&(i-=360),i}((t.clientX-s.left)*o-mt,(t.clientY-s.top)*o-_t)}_onPointerDown(t){t.preventDefault(),t.stopPropagation(),this._dragging=!0,this._dragStarted=!1,this._lastRawAngle=this._rawAngleFromPointer(t),t.currentTarget.setPointerCapture(t.pointerId)}_onPointerMove(t){if(!this._dragging)return;t.preventDefault();const e=this._rawAngleFromPointer(t);let i=e-this._lastRawAngle;i>180&&(i-=360),i<-180&&(i+=360);let s=this._totalAngle+i;s=Math.max(0,Math.min(this._maxAngle,s)),this._totalAngle=s,this._lastRawAngle=e,this._dragStarted=!0}_onPointerUp(t){this._dragging&&this._dragStarted&&this._timerMinutes>0&&this.hass.callService("switcher_kis","turn_on_with_timer",{entity_id:this.config.entity,timer_minutes:String(this._timerMinutes)}),this._dragging=!1,this._dragStarted=!1}_toggleBoiler(t){t.stopPropagation(),this.hass.callService("homeassistant","toggle",{entity_id:this.config.entity})}_showMoreInfo(t,e){t.stopPropagation(),e&&this.dispatchEvent(new CustomEvent("hass-more-info",{bubbles:!0,cancelable:!0,composed:!0,detail:{entityId:e}}))}render(){var t,e,i,s,o;const n=null===(e=null===(t=this.hass)||void 0===t?void 0:t.states)||void 0===e?void 0:e[this.config.entity];if(!n)return;const r=(null===(i=n.attributes)||void 0===i?void 0:i.friendly_name)||"Boiler",a=this.config.name||r,l="on"===n.state,c=this.config.icon||(null===(s=n.attributes)||void 0===s?void 0:s.icon)||"mdi:waves";let h=l?this.hass.localize("component.switch.entity_component._.state.on")||"on":this.hass.localize("component.switch.entity_component._.state.off")||"off";if(l&&this.config.time_left&&this.hass.states[this.config.time_left]&&(h=this.hass.states[this.config.time_left].state),this.config.power_sensor&&this.hass.states[this.config.power_sensor]){const t=this.hass.states[this.config.power_sensor],e=(null===(o=t.attributes)||void 0===o?void 0:o.unit_of_measurement)||"";h+=` • ${t.state}${e}`}const d=this._partialAngle,u=this._fullRotations,p=bt*(1-(0===d&&u>0?360:d)/360),f=this._totalAngle>0,g=function(t){const e=(t%360-90)*(Math.PI/180);return{x:mt+vt*Math.cos(e),y:_t+vt*Math.sin(e)}}(this._totalAngle),m=this._dragging?16:13;return V`
      <ha-card class="card">
        <!-- ── Header ─────────────────────────────────────────────────── -->
        <div
          class="card-header"
          @click="${t=>this._showMoreInfo(t,this.config.entity)}"
        >
          <div class="icon-container ${l?"on":"off"}">
            <ha-icon icon="${c}" class="icon ${l?"on":"off"}"></ha-icon>
          </div>
          <div class="header-label">
            <span class="primary">${a}</span>
            <span class="secondary">${h}</span>
          </div>
        </div>
        ...
        <div class="timer-wrapper">
          ...
          >
            ...
            ${[0,15,30,45].map((t=>{const e=(t/60*360-90)*(Math.PI/180);return F`
                <line
                  x1="${mt+77*Math.cos(e)}"
                  y1="${_t+77*Math.sin(e)}"
                  x2="${mt+93*Math.cos(e)}"
            ...
            ${[{min:15,text:"15"},{min:30,text:"30"},{min:45,text:"45"}].map((({min:t,text:e})=>{const i=(t/60*360-90)*(Math.PI/180);return F`
                <text
                  x="${mt+107*Math.cos(i)}"
                  y="${_t+107*Math.sin(i)}"
                  text-anchor="middle"
    ...
    `}getCardSize(){return 4}getLayoutOptions(){return{grid_rows:3,grid_columns:2,grid_min_rows:3,grid_max_rows:3,grid_min_columns:2,grid_max_columns:2}}}$t.styles=gt,t([ut()],$t.prototype,"_totalAngle",void 0),t([ut()],$t.prototype,"_dragging",void 0),t([dt({attribute:!1})],$t.prototype,"hass",void 0),t([dt({attribute:!1})],$t.prototype,"config",void 0);var yt=r`
...
`;const wt=[{name:"entity",selector:{entity:{domain:["switch"]}}},{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}},context:{icon_entity:"entity"}},{name:"time_left",selector:{entity:{domain:["sensor"]}}},{name:"sensor_1",selector:{entity:{domain:["sensor"]}}},{name:"sensor_2",selector:{entity:{domain:["sensor"]}}},{name:"icon_sensor",selector:{entity:{domain:["sensor"]}}},{name:"color_thresholds",selector:{boolean:{}}},{type:"grid",name:"",schema:[{name:"cold_threshold",selector:{number:{min:10,max:80,step:1,mode:"slider"}}},{name:"hot_threshold",selector:{number:{min:10,max:80,step:1,mode:"slider"}}}]},{name:"temp_resolution",selector:{number:{min:0,max:2,step:1,mode:"slider"}}},{name:"timer_values",selector:{}}];class xt extends at{constructor(){super(...arguments),this._config={},this._valueChanged=t=>((t,e,i,s={})=>{const o=new CustomEvent(e,{bubbles:void 0===s.bubbles||s.bubbles,cancelable:Boolean(s.cancelable),composed:void 0===s.composed||s.composed,detail:i});return t.dispatchEvent(o),o})(this,"config-changed",{config:t.detail.value}),this._computeLabelCallback=t=>{const{name:e}=t;switch(e){case"time_left":return"Time Left Sensor (Optional)";case"sensor_1":return"Sensor 1 - On state (Optional)";case"sensor_2":return"Sensor 2 - On and Off state (Optional)";case"icon_sensor":return"Icon Sensor (Optional)";case"color_thresholds":return"Color Thresholds (Optional)";case"cold_threshold":return"Cold Threshold";case"hot_threshold":return"Hot Threshold";case"temp_resolution":return"Temperature Resolution (Optional)";default:return`${this.hass.localize(`ui.panel.lovelace.editor.card.generic.${e}`)} (${this.hass.localize("ui.panel.lovelace.editor.card.config.optional")})`}}}setConfig(t){this._config=Object.assign(Object.assign({},t),{timer_values:[...new Set((t.timer_values||["15","30","45","60"]).map(Number).filter((t=>t>=1&&t<=150)).sort(((t,e)=>t-e)).map(String))]})}render(){return this.hass&&this._config?V`
    ...
    `}_onTimerValueChanged(t){var e;const i=t.target,s=null==i?void 0:i.value,o=null!==(e=null==i?void 0:i.checked)&&void 0!==e&&e,n=this._config.timer_values||[],r=o?[...n,s]:n.filter((t=>t!==s)),a=r.filter((t=>void 0!==t)).sort(((t,e)=>parseInt(t)-parseInt(e)));this._valueChanged(new CustomEvent("value-changed",{detail:{value:Object.assign(Object.assign({},this._config),{timer_values:a})}}))}}xt.styles=yt,t([ut()],xt.prototype,"_config",void 0);const At=[{name:"entity",selector:{entity:{domain:["switch"]}}},{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}},context:{icon_entity:"entity"}},{name:"time_left",selector:{entity:{domain:["sensor"]}}},{name:"power_sensor",selector:{entity:{domain:["sensor"]}}},{name:"timer_limit",selector:{number:{min:15,max:150,step:15,mode:"slider"}}}];class St extends at{constructor(){super(...arguments),this._config={},this._computeLabel=t=>{switch(t.name){case"time_left":return"Time Left Sensor (Optional)";case"power_sensor":return"Power Consumption Sensor (Optional)";case"timer_limit":return"Timer Limit in Minutes (Optional)";default:return`${this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)} (${this.hass.localize("ui.panel.lovelace.editor.card.config.optional")})`}},this._valueChanged=t=>{return e=this,i="config-changed",s={config:t.detail.value},void e.dispatchEvent(new CustomEvent(i,{bubbles:!0,cancelable:!1,composed:!0,detail:s}));var e,i,s}}setConfig(t){this._config=t}render(){return this.hass&&this._config?V`
      <ha-form
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:V``}}t([ut()],St.prototype,"_config",void 0);console.groupCollapsed("%c SWITCHER-BOILER-CARD %c v1.4.2","color: white; background: #F54436; font-weight: bold","color: #F54436; font-weight: bold"),console.log("Readme:","https://github.com/Puuuchkie/switcher-boiler-dial-card"),console.groupEnd(),customElements.define("switcher-boiler-card",ft),customElements.define("switcher-boiler-card-circular",$t),customElements.define("switcher-boiler-card-editor",xt),customElements.define("switcher-boiler-card-circular-editor",St),window.customCards=window.customCards||[],window.customCards.push({type:"switcher-boiler-card",name:"Switcher Boiler Dial Card",description:"Custom Switcher Boiler Switch card for Home Assistant",preview:!0,documentationURL:"https://github.com/Puuuchkie/switcher-boiler-dial-card",configurable:!0}),window.customCards.push({type:"switcher-boiler-card-circular",name:"Switcher Boiler Dial Card (Circular Timer)",description:"Switcher Boiler card with a draggable circular timer dial",preview:!0,documentationURL:"https://github.com/Puuuchkie/switcher-boiler-dial-card",configurable:!0});
