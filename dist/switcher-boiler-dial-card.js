      ...
      <ha-card class="card">
        ...
        <div class="timer-wrapper">
          <svg class="timer-svg" viewBox="0 0 240 240" xmlns="http://www.w3.org/2000/svg">
            ...
            ${[0,15,30,45].map((t=>{const e=At(xt(t,wt));return F`
